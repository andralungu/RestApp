...
--
-- Host: localhost
-- Generation Time: Feb 13, 2014 at 08:42 AM
...
(1, 'getmoving', 'user', 'id', '', '', '_', ''),
(2, 'getmoving', 'user', 'firstname', '', '', '_', ''),
(3, 'getmoving', 'user', 'secondname', '', '', '_', ''),
(4, 'getmoving', 'user', 'username', '', '', '_', ''),
(5, 'getmoving', 'user', 'password', '', '', '_', ''),
(6, 'getmoving', 'user', 'gender', '', '', '_', ''),
(7, 'getmoving', 'user', 'bmonth', '', '', '_', ''),
(8, 'getmoving', 'user', 'bday', '', '', '_', ''),
(9, 'getmoving', 'user', 'byear', '', '', '_', ''),
(10, 'getmoving', 'user', 'type', '', '', '_', ''),
(11, 'getmoving', 'user', 'id_u', '', '', '_', '');
